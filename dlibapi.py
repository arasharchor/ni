...
def face_encodings_known_location(face_image, pose_predictor, face_encoder, face_aligner, face_locations, num_jitters=1):

    raw_landmarks = [pose_predictor(face_image, dlib.rectangle(face_location[1], face_location[0], face_location[3], face_location[2])) for face_location in face_locations]

    #raw_landmarks = [pose_predictor(face_image, face_location) for face_location in face_locations] 


    alignedFaces = [face_aligner.align(96, face_image, face_location,  landmarkIndices=openface.AlignDlib.OUTER_EYES_AND_NOSE, skipMulti = 'store_true') for face_location in face_locations] #534
